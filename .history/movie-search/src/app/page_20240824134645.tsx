...
import './page.css';
import RatedMovies from './RatedMovies';  // Import the RatedMovies component
...
const handleRate = async (movieId: number, rating: number) => {
  ...
  try {
    ...
    // Fetch updated rated movies immediately after rating
    fetchRatedMovies();
  } catch (err) {
  ...
  const tabItems = [
    ...
    },
    {
      key: "2",
      label: "Rated",
      children: <RatedMovies sessionId={sessionId!} genres={genres} />,
    },
  ];
